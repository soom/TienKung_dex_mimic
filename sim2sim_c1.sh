...
cd "$SCRIPT_DIR"
POLICY="${POLICY:-logs/rsl_rl/walker_c1_fix/0720_042712_walker_c1_full/exported/policy_merged.onnx}"

# ── 默认 NPZ 目录 ──────────────────────────────────────────────────────────
DEFAULT_NPZ_DIR="dataset/npz_c1"
NPZ_DIR="${NPZ_DIR:-$DEFAULT_NPZ_DIR}"

# ── 默认 MJCF ──────────────────────────────────────────────────────────────
DEFAULT_MJCF="source/whole_body_tracking/whole_body_tracking/assets/walker_c1/mjcf/walker_astron.xml"
...
echo "========================================"
echo " Walker C1 sim2sim — playlist mode"
echo "========================================"
echo " Policy  : $POLICY"
